...
static void example_lvgl_flush_cb(lv_disp_drv_t *drv, const lv_area_t *area, lv_color_t *color_map) {
    ...
    ESP_ERROR_CHECK(epaper_panel_set_custom_lut(panel_handle, SSD1681_WAVESHARE_1IN54_V2_LUT_FULL_REFRESH, sizeof(SSD1681_WAVESHARE_1IN54_V2_LUT_FULL_REFRESH)));
    // ESP_ERROR_CHECK(epaper_panel_set_custom_lut(panel_handle, SSD1681_WAVESHARE_1IN54_V2_LUT_FAST_REFRESH, sizeof(SSD1681_WAVESHARE_1IN54_V2_LUT_FAST_REFRESH)));
    // ESP_ERROR_CHECK(epaper_panel_set_custom_lut(panel_handle, SSD1681_WAVESHARE_1IN54_V2_LUT_FAST_REFRESH_KEEP, sizeof(SSD1681_WAVESHARE_1IN54_V2_LUT_FAST_REFRESH_KEEP)));

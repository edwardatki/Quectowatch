...
class AdjustMenu(AbstractMenu):
    ...
    def get_title_label(self):
        title = Label(FONT, scale=1, padding_top=PADDING_V_PX, padding_bottom=PADDING_V_PX,padding_right=PADDING_H_PX,padding_left=PADDING_H_PX)
        title.text = '* ' + self.label + ' *'
        title.anchor_point = (0.5, 0)
        title.anchored_position = (self._width / 2, 0)
        
        title.color = 0xffffff
        title.background_color = 0x000000
        return title
...
class BoolMenu(AdjustMenu):
    ...
    def build_displayio_group(self):
        ...
        prop_text.color = 0xffffff
        prop_text.background_color = 0x000000
